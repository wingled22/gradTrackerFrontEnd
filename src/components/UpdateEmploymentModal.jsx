...
const UpdateEmployeeModal = ({ toggled, untoggle }) => {
  ...
  return (
    <div>
      ...
      <Modal isOpen={toggled} toggled={untoggle} className="EmpUpdatemodalForm">
        <ModalHeader toggle={untoggle} className="EmpUpdateHeader text-center">
         ...
         <div className="thin-Rounded">
          <Row>
           ...
           <p className="update-position-title fs-6 ">Position</p>
            <p className="update-position-sub fs-2">Sr. Web Developer</p>
           </div>
          </Row>
          <Row>
