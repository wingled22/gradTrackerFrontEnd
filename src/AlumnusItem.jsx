...
const AlumnusItem = ({ alumnus }) => {
    ...
    const
        {
            id, firstName, middleName, lastName, birthDate, sex,
            province, municipality, barangay, street,
            email, contactNumber,
            department, program, yearGraduated
        } = alumnus;
           ...
           <EmployeeHistory toggled={modal} untoggle={toggleEmpHistory}></EmployeeHistory>
            ...
            <AccordionItem style={accordionStyle} key={id}>
                ...
                >
                    ...
                    <span className="nameLabel"> <b> Name : </b> {firstName + " " + lastName}</span>{" "}
                    <br />
                    <span className="genderLabel"> <b>Sex :</b> {sex}</span>{" "}
                    <br />
                    ...
                    <span className="addressLabel">
                        <b>Address :</b> {street + ", " + barangay + ", " + municipality + ", " + province}
                    </span> <br /> <br />
