            ...
            personalInfos.map(personalInfo => (
                <AccordionItem style={accordionStyle} key={personalInfo.id}>
                    ...
                    <AccordionBody accordionId={personalInfo.id} style={{ backgroundColor: '#F8F8F8' }}>
                        ...
                        <span className='birthDateLabel'>Birthdate : {personalInfo.birthdate}</span> <br />
                        <span className='addressLabel'>Address : Sambag</span> <br /> <br />
                        <span className='contactLabel'>Contact Number : 09213123123</span> <br />
                        <span className='emailAddLabel'>Email Address : emailniya@gmail.com</span> <br /> <br />

                        <div style={departmentStyle}>
                            <span className='departmentLabel'>Department : {personalInfo.department}</span> <br />
                            <span className='programLabel'>Program : Bachelor of Science in Tuba</span> <br />
                            <span className='yearGraduatedLabel'>Year Graduated : 2024</span> <br /> <br />
                        </div>

                        <div className="d-flex justify-content-end" >
                            <Button color='success' className='mr-2' style={buttonStyle}>Employment History</Button>
                            <Button color='success' style={buttonStyle}>Update</Button>
                        </div>
                    </AccordionBody>
                </AccordionItem>
            ))
